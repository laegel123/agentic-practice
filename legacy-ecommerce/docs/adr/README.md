...
| [0002](./0002-shared-h2-file-database.md) | H2 파일 DB + 이커머스·배치 공유 | Accepted · 재검토 대상 (0008 보완) |
...
| [0008](./0008-batch-read-only-shared-db-consumer.md) | batch 를 공유 shop DB 의 읽기 전용 소비자로 명시 | Accepted (0002 보완) |
