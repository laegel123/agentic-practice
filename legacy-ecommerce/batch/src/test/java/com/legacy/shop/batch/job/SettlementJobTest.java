...
class SettlementJobTest {
    ...
    private OrderRow order(OrderStatus status, String totalAmount) {
    ...
    void settle_excludesCancelledOrders_sumsTheRest() {
        ...
        assertThat(settlementJob.settle()).isEqualByComparingTo("150.0");
    }
    ...
    void settle_emptyOrders_isZero() {
        ...
        assertThat(settlementJob.settle()).isEqualByComparingTo("0");
    }
}
